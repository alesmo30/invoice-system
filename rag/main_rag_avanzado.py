...
""")
    ...
    question = "El dia 4 de marzo de 2026, que vendio la empleada Camila Ruiz?"
    ...
    info(
        ...
        "pero puede fallar con códigos exactos como fechas o nombres de personas."
    )
...
""")
    ...
    hybrid = HybridRetriever(collection, all_chunks, alpha=0.3)
    ...
    question_mq = "El dia 4 de marzo de 2026, que vendio la empelada Camila Ruiz"
    ...
    question_rr = "El dia 4 de marzo de 2026, que vendio la empelada Camila Ruiz"
    ...
    question_cc = "El dia 4 de marzo de 2026, que vendio la empelada Camila Ruiz"
    ...
    question_full = (
        "El dia 4 de marzo de 2026, que vendio la empelada Camila Ruiz"
    )
